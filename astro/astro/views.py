...
data = {'planets': [
            {'name': 'Меркурий', 'id': 1, 
             ...
             'img': 'http://localhost:9000/images/1.jpg',
             'detImg': 'http://localhost:9000/images/detImgs/1.jpg',
            ...
            {'name': 'Венера', 'id': 2, 
             ...
             'img': 'http://localhost:9000/images/2.jpg',
             'detImg': 'http://localhost:9000/images/detImgs/2.jpg',
            ...
            {'name': 'Юпитер', 'id': 3, 
             ...
             'img': 'http://localhost:9000/images/3.jpg',
             'detImg': 'http://localhost:9000/images/detImgs/3.jpg',
            ...
            {'name': 'Марс', 'id': 4, 
             ...
             'img': 'http://localhost:9000/images/4.jpg',
             'detImg': 'http://localhost:9000/images/detImgs/4.jpg',
            ...
            {'name': 'Сатурн', 'id': 5, 
             ...
             'img': 'http://localhost:9000/images/5.jpg',
             'detImg': 'http://localhost:9000/images/detImgs/5.png',
            ...
            {'name': 'Нептун', 'id': 6, 
             ...
             'img': 'http://localhost:9000/images/6.jpg',
             'detImg': 'http://localhost:9000/images/detImgs/6.png',
            ...
            {'name': 'Уран', 'id': 7, 
             ...
             'img': 'http://localhost:9000/images/7.jpg',
             'detImg': 'http://localhost:9000/images/detImgs/7.png',
...
def getServices(request):
    data['searchText'] = request.GET.get('PlanetName', '')
